// ============================================================
// GRSS FIELD ANALYST — SET 1 (Original Launch Pack)
// The content the game has always shipped with. Kept verbatim so
// selecting Set 1 reproduces the original game exactly.
// Answers never leave the server — clients receive stripped payloads.
// ============================================================

import type { ServerGameData, QuestionSet, LevelIntro } from './types';

const SET1_DATA: ServerGameData = {
  level1: {
    scrambles: [
...
const SET1_INTROS: Record<number, LevelIntro> = {
...
export const SET1: QuestionSet = {
  id: 'set1',
  label: 'Set 1 — Original Launch Pack',
  description: 'The original GRSS Field Analyst question set.',
  data: SET1_DATA,
  intros: SET1_INTROS,
  timeLimits: SET1_TIME_LIMITS,
};
